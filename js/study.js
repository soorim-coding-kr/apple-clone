        ...
        switch (currentScene) {
            ...
            case 3:
                ...
                if (scrollRatio < values.rect1X[2].end) {
                    ...
                    //sWidth, sHeight (s= source = 원래 그릴 이미지) // 원래 이미지에서 그려지길 원하는 영역(=crop)
                    //dWidth, dHeight (d= destination = 캔버스에 실제로 그리는 이미지) //crop한 이미지를 캔버스에 원하는 크기와 원하는 위치로 올림
                    ...
                    if (scrollRatio > values.blendHeight[2].end) {
                        ...
                        // objs.canvas.style.transition = `0.3s`;
                    }
                    if (
